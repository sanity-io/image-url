(function (global, factory) {
  ...
  function specToImageUrl(spec) {
    var _process$env$SANITY_S;

    var cdnUrl = (spec.baseUrl || 'https://cdn.sanity.io').replace(/\/+$/, '');
    var filename = spec.asset.id + "-" + spec.asset.width + "x" + spec.asset.height + "." + spec.asset.format;
    var dataset = (_process$env$SANITY_S = process.env.SANITY_STUDIO_IMAGE_DATASET_OVERRIDE) != null ? _process$env$SANITY_S : spec.dataset;
    var baseUrl = cdnUrl + "/images/" + spec.projectId + "/" + dataset + "/" + filename;
    var params = [];
